...
export async function POST(req: NextRequest) {
  try {
    ...
    // Einladungslinks zeigen auf die separate Portal-App (eigene Domain);
    // Fallback: aktuelle Request-Domain (Dev ohne gesetzte Variable)
    const baseUrl = process.env.PORTAL_BASE_URL || getRequestBaseUrl(req);
