  ...
  if (error || !project) {
    return (
      <div className="max-w-xl space-y-4">
        ...
        <Button variant="outline" onClick={() => router.push('/projekte')}>
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        ...
        {project.billableCount > 0 && (
          <Button
            onClick={() => router.push(`/rechnungen/neu?projectId=${project.id}`)}
      ...
      <div className="text-sm text-slate-500 dark:text-slate-400">
        ...
        <Link href={`/dokumente?projectId=${project.id}`} className="text-blue-600 dark:text-blue-400 hover:underline">
          Dokumente
        </Link>
        .
      </div>
