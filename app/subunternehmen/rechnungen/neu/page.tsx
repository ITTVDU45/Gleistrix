    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      <div>
        <Button
          variant="ghost"
          size="sm"
          onClick={() => router.push('/subunternehmen/rechnungen')}
      ...
      <InvoiceEditor
        ...
        onSaved={(invoice) => router.push(`/subunternehmen/rechnungen/${invoice.id}`)}
        onCancel={() => router.push('/subunternehmen/rechnungen')}
      />
    </div>
  )
}
