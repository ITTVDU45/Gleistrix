...
const portalNavigation = [
  { name: 'Übersicht', href: '/subunternehmen', icon: LayoutDashboard },
  { name: 'Meine Projekte', href: '/subunternehmen/projekte', icon: Building2 },
  { name: 'Einsätze & Stunden', href: '/subunternehmen/einsaetze', icon: Clock },
  { name: 'Rechnungen', href: '/subunternehmen/rechnungen', icon: FileText },
  { name: 'Dokumente', href: '/subunternehmen/dokumente', icon: FolderOpen },
  { name: 'Unternehmensprofil', href: '/subunternehmen/unternehmen', icon: Settings },
]
...
export default function PortalShell({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (href: string) =>
    href === '/subunternehmen' ? pathname === href : pathname.startsWith(href)
